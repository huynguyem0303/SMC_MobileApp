                ...
                <Animated.View style={{ flex: 1, transform: [{ translateX: slideAnim }] }}>
                    ...
                    <ScrollView style={styles.scrollView}>
                        <View style={styles.section}>
                            ...
                            <TouchableOpacity style={styles.menuItem} onPress={() => router.push('../Projects/MentorLecturerProjectListScreen')}>
                                <Image source={require('../assets/images/project-icon.png')} style={styles.icon} />
                                <Text style={styles.menuText}>My Project List</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.section}>
                            <Text style={styles.sectionTitle}>Appointments</Text>
                            <TouchableOpacity style={styles.menuItem} onPress={() => router.push('../Appointments/MentorLecturerCalendarScreen')}>
...
export default MentorLecturerMenuScreen;
